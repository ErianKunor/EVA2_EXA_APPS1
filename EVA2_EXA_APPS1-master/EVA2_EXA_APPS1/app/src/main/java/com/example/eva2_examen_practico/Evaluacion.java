...
public class Evaluacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sbCalificacion.setMax(3);
        sbCalificacion.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (progress == 0){
                    imgVwEs1.setImageResource(R.drawable.estrellan);
                    imgVwEs2.setImageResource(R.drawable.estrellan);
                    imgVwEs3.setImageResource(R.drawable.estrellan);
                }
                if (progress == 1){
                    imgVwEs1.setImageResource(R.drawable.estrellaa);
                    imgVwEs2.setImageResource(R.drawable.estrellan);
                    imgVwEs3.setImageResource(R.drawable.estrellan);
                }
                if (progress == 2){
                    imgVwEs1.setImageResource(R.drawable.estrellaa);
                    imgVwEs2.setImageResource(R.drawable.estrellaa);
                    imgVwEs3.setImageResource(R.drawable.estrellan);
                }
                if (progress == 3){
                    imgVwEs1.setImageResource(R.drawable.estrellaa);
                    imgVwEs2.setImageResource(R.drawable.estrellaa);
                    imgVwEs3.setImageResource(R.drawable.estrellaa);
                }
